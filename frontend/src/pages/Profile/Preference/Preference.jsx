...
function Preference(){
    ...
    const handleSubmit = () => {
        console.log("Selected style preferences:", stylePreferences);
    ...
    return(
        <div>
            <div className="contener align-items-center justify-content-center">
    ...
    */}                <div className="cont">
                ...
                <div className="main-cont d-flex">
                    <button type="button" className="btn btn-success mx-auto" onClick={handleSubmit}>Zapisz</button>
                </div>
            </div>
        </div>
    )
